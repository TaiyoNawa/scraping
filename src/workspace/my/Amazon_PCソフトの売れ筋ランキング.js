...
CSVを見やすくしたい時はコマンドパレットで「>RBQL」と入力
*/
...
const directoryName = "PCソフトの売れ筋ランキング"//取得するものの名前
    ...
    try {
      ...
      for (let i = 1; i <= 2; i++) {
        try {
          ...
          const URL = `https://www.amazon.co.jp/gp/bestsellers/software/ref=zg_bs_pg_${i}_software?ie=UTF8&pg=${i}`
