...
const baseUrl = 'https://expo.bizcrew.jp/web_api/v2/booth/569/13748/350013';
...
(async () => {
  ...
  items.forEach((i) => {
    const url =
      'https://expo.bizcrew.jp/event/13748/module/booth/350013/' + i.booth_id; //ここのURLは適宜変えて
  ...
  toCSV(results, path.join('output', '2025_06_23', 'BizcrewExpo2025URL.csv'));
})();
